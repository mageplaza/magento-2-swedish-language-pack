...
#### Suggestions
- You can copy any part of `sv_SE.csv` and paste to `github_contributions.csv` then translate it.
- Please do not copy all lines in `sv_SE.csv`, we will not approve it in this case.
