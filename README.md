...
2. [Install Swedish Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Swedish language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Swedish language pack {#active}
